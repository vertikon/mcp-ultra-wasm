...
| prealloc | 2 | 🟢 Baixa | ~10min |

### 📁 Arquivos Mais Problematicos

1. pkg\orchestrator\types.go (12)
2. pkg\registry\registry.go (3)
3. internal\seeds\manager.go (2)
4. pkg\contracts\route.go (1)
...
2. **prealloc** (2 issues) - Pre-aloque slice com capacidade estimada: make([]Type, 0, expectedSize)
